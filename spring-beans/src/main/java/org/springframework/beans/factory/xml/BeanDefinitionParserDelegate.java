...
// 解析 factory-method 属性
	...
	public BeanDefinition parseCustomElement(Element ele, @Nullable BeanDefinition containingBd) {
		...
		//1.调用 XmlReaderContext#getNamespaceHandlerResolver() 方法，获得命名空间的解析器
		//2.调用 NamespaceHandlerResolver#resolve(String namespaceUri) 方法，根据 namespaceUri 获取相应的 Handler 对象。
